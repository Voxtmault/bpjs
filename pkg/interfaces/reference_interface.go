...
type Reference interface {
	...
	DoctorReference(ctx context.Context, kodeDokter string) ([]*models.Reference, error)
	PolyclinicsReference(ctx context.Context, poliCode string) ([]*models.Reference, error)
	...
	AttendingPhysicianReference(ctx context.Context, jenisPelayanan, tglPelayanan, kodeSPesialis string) ([]*models.Reference, error) // DPJP
	...
	TreatmentRoomReference(ctx context.Context) ([]*models.Reference, error)
}
